...
public class StoreInterestTest {
	...
	MemberService memberService = new SimpleMemberService(memberEventHandler, mock(PasswordEncoder.class), storeRepository);
	...
	void 업체에_관심도_주기() {
		...
		memberService.interest(me, targetStoreOwner);
	}
}
