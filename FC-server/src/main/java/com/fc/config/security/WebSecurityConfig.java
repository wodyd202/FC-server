package com.fc.config.security;
...
import com.fc.config.security.jwt.JwtAuthenticationFilter;
import com.fc.config.security.jwt.JwtAuthenticationToken;
import com.fc.config.security.jwt.JwtTokenProvider;
import com.fc.config.security.jwt.JwtTokenResolver;
import com.fc.config.security.jwt.TokenStore;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.formLogin().disable()
		.authorizeRequests()
		.antMatchers(HttpMethod.GET, "/api/v1/member/**/exist").permitAll()
		.antMatchers(HttpMethod.GET, "/api/v1/member/**/address").authenticated()
		.antMatchers(HttpMethod.GET, "/api/v1/product/**").permitAll()
		.antMatchers(HttpMethod.GET, "/api/v1/product").permitAll()
		.antMatchers(HttpMethod.GET, "/api/v1/member/interest-store").authenticated()
		.antMatchers(HttpMethod.GET, "/api/v1/member/interest-product").authenticated()
		...
		.antMatchers(HttpMethod.POST, "/api/v1/member/**").authenticated()
